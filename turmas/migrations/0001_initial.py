# Generated by Django 2.2.4 on 2019-11-12 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atividade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problemas', to='turmas.Atividade')),
            ],
        ),
        migrations.CreateModel(
            name='Turma',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissoes', to='turmas.Problema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submissao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turmas.Submissao')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='turma',
            name='estudantes',
            field=models.ManyToManyField(blank=True, to='turmas.Estudante'),
        ),
        migrations.AddField(
            model_name='turma',
            name='professor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='turmas', to='turmas.Professor'),
        ),
    ]
